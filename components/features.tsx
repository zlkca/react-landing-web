        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Lead and Deal Management</h4>
              <p className="text-lg text-gray-400 text-center">Efficiently track and manage leads throughout the sales cycle, from initial contact to conversion. Organize leads by source, status, and priority, and easily move them through customizable deal stages to streamline your sales process.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Contact Management</h4>
              <p className="text-lg text-gray-400 text-center">Keep all customer information in one central database, including contact details, communication history, and preferences. Access comprehensive profiles for each contact to personalize interactions and strengthen relationships.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Task and Activity Tracking</h4>
              <p className="text-lg text-gray-400 text-center">Stay on top of tasks and activities with built-in reminders and notifications. Assign tasks to team members, set deadlines, and track progress in real-time to ensure nothing falls through the cracks.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Reporting and Analytics</h4>
              <p className="text-lg text-gray-400 text-center">Gain valuable insights into your sales performance and customer behavior with robust reporting and analytics tools. Generate customizable reports, visualize data trends, and make data-driven decisions to optimize your sales and marketing strategies.</p>
            </div>
