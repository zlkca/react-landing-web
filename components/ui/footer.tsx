      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  ...
                  <img src="/images/logo192.png" alt="logo" width={64} height={64} style={{marginTop:20}}/>
                  <div style={{fontSize:12}}>Podtree</div>
                </Link>
              </div>
              <div className="text-gray-400">Empower your business with our all-in-one online shop and management solution.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link href="https://demo.podtree.ca" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Online Shop</Link>
                  </li>
                  {/* <li className="mb-1">
                    <Link href="/code-generator" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Code Generator</Link>
                  </li> */}
                  <li className="mb-1">
                    <Link href="https://admin.podtree.ca" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">ERP</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="https://admin.podtree.ca" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Inventory Management</Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Podtree</Link>
                  </li>
                  {/* <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Podtree.ca. All rights reserved.</div>
